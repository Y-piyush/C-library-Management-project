...
void modify_student(){
cout<<"\nAdmission no.:"<<admno;fflush(stdin);
...
cout<<"\n\n\t\t\tSTUDENT LIST\n\n";
cout<<"=================================================================\n";
cout<<"\tAdmission No."<<setw(10)<<"Name"<<setw(23)<<"Book Issued\n";
cout<<"=================================================================\n";
while(fp.read((char*)&st,sizeof(student)))
{
st.report();
...
cout<<"Please Note: Write the current date in backside of your";
cout<<"book and submit within 15 days fine Rs.1 for each day";
